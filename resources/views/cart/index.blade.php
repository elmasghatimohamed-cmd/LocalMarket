            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="lg:w-1/3">
                    <div class="bg-cardBg rounded-[2.5rem] p-8 border border-white/5 sticky top-8 shadow-2xl">
                        ...
                        <button class="w-full bg-protech hover:bg-white text-black font-tech text-sm py-5 rounded-2xl mt-10 transition-all shadow-[0_10px_20px_rgba(223,255,0,0.15)] active:scale-[0.98] flex items-center justify-center gap-3 group">
                            INITIATE CHECKOUT
