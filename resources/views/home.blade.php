    ...
    <div class="relative h-[500px] flex items-center">
        <div x-show="activeSlide === 1" class="container mx-auto px-6 grid md:grid-cols-2 items-center gap-12">
            ...
            <div class="relative hidden md:block">
                ...
                <img src="https://webshop.asus.com/media/ea/aa/b2/1765772959/rtx5060-o8g-lp-brk-box-card-282887551-90yv0n90-m0na00-webp_1765772958.webp?ts=1765772959" class="relative z-10 w-full rotate-12 drop-shadow-2xl">
            </div>
        </div>
    </div>
</section>
