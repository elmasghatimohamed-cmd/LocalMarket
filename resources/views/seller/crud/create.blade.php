...
<body class="p-4 md:p-12">
    ...
    <div class="max-w-3xl mx-auto">
        <a href="{{ route('seller.crud.index') }}"
            class="inline-flex items-center text-gray-500 hover:text-[#DFFF00] transition-colors mb-8 text-sm font-bold uppercase tracking-widest">
            ...
            <div class="bg-[#141414] border border-[#222] p-6 md:p-10 rounded-[32px] shadow-2xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] uppercase tracking-widest text-gray-500 font-extrabold mb-3">Product
                            Name</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-widest text-gray-500 font-extrabold mb-3">Category</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-widest text-gray-500 font-extrabold mb-3">Price
                            (USD)</label>
                        <div class="relative">
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-widest text-gray-500 font-extrabold mb-3">Stock
                            Quantity</label>
                    ...
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] uppercase tracking-widest text-gray-500 font-extrabold mb-3">Description</label>
