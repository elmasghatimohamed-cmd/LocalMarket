            ...
            <div class="bg-[#141414] border border-[#222] p-6 md:p-10 rounded-[32px] shadow-2xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] uppercase tracking-[0.2em] text-gray-500 font-extrabold mb-3">Product
                            Identifier</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-[0.2em] text-gray-500 font-extrabold mb-3">System
                            Category</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-[0.2em] text-gray-500 font-extrabold mb-3">Market
                            Price ($)</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-[0.2em] text-gray-500 font-extrabold mb-3">Inventory
                            Count</label>
                    ...
                    <div>
                        <label
                            class="block text-[10px] uppercase tracking-[0.2em] text-gray-500 font-extrabold mb-3">Visual
                            Media</label>
                        <input type="file" name="image" accept="image/*"
                            class="w-full bg-[#0A0A0A] border border-[#222] rounded-xl px-2 py-2 text-sm text-gray-500 file:font-bold">
                        <p class="text-[9px] text-gray-600 mt-2 uppercase italic tracking-tighter">Current asset will
                            persist if no file is selected.</p>
                    </div>
